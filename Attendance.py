...
# Load known faces
daksh_image = face_recognition.load_image_file("faces/daksh.jpeg")
daksh_encoding = face_recognition.face_encodings(daksh_image)[0]
...
known_face_encodings = [daksh_encoding]
known_face_names = ["Daksh", "Rohan", "Ansh"]
